...
args = ["qemu-system-x86_64", 
	"test.qcow2",
	#"sifive_e", 
	"-cdrom","Fedora-Live-Desktop-x86_64-20-1.iso", 	# see QEMU documentation for more details, 				 
								#or use qemu-system-riscv64 -machine help
	"-kernel", "hello", 	# launches the file at path on the guest system
